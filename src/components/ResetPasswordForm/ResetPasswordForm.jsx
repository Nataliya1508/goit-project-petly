...
const ResetPasswordForm = () => {   
    ...
    const handleSubmit = async ({password, passwordConfirmation}, {resetForm}) => {
        ...
        try {
            setIsLoading(true)
            const data = await resetPassword(recoveryToken, resetData)
    ...
    return (
        <Box width={{base:'280px', md:'608px', xl:'618px'}} px={{base:'0', md:'20'}} pt={{base:'22px', md:'60px'}} pb={{base:'0', md:'10', xl:'60px'}} borderRadius='40px' boxShadow={{base:'0', md:'7px 4px 14px rgba(0, 0, 0, 0.11)'}} bgColor={{base:'accent.background', md:'white'}} mx='auto'>
            <Heading as='h1' mb='10' mt={{base:'0'}} textAlign='center' fontWeight='medium'>New password</Heading>
            <Formik 
                ...
                {formik => (
                    <Box as={Form} position='relative' width={{base:'280px', md:'448px', xl:'458px'}} >
                        ...
                        <FormikControl
                            ...
                            mb='0' 
                        />
                        <Button isDisabled={formik.isSubmitting} type='submit' controle='secondary' mb='40px' mt='40px' h={{base:'44px', xl:'48px'}} width={{base:'280px', md:'448px', xl:'458px'}} isLoading={isLoading} loadingText={"Update"}>Update your password</Button>
