...
const ResetForm = () => {   
    ...
    return (
        <Box width={{base:'280px', md:'608px', xl:'618px'}} px={{base:'0', md:'20'}} pt={{base:'22px', md:'60px'}} pb={{base:'0', md:'10', xl:'60px'}} borderRadius='40px' boxShadow={{base:'0', md:'7px 4px 14px rgba(0, 0, 0, 0.11)'}} bgColor={{base:'accent.background', md:'white'}} mx='auto'>
            <Heading as='h1' mb='10' mt={{base:'0'}} textAlign='center' fontWeight='medium'>Reset password</Heading>
            <Text mb={6}>Please enter the email you use to login. We will send you an email to reset your password.</Text>
            <Formik 
