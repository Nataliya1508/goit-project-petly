...
import { SimpleGrid, CardHeader, Card, Text, Box, Image, Link, Stack, CardBody } from '@chakra-ui/react'
...
export const OurFriendsList = ({ friends }) => {
    return (
      ...
      >
        {friends.map(
          ({_id, title, url, addressUrl, address, imageUrl, workDays, phone, email,
          }) => (
            <Card
            bgColor={'#FFFFFF'}
            borderRadius={'20px'}
            ...
            >
              ...
              <Stack
                ...
                <Stack>
                  ...
                  type='email'>
                    Email:
                    <Link href="mailto:{address}"> {email ? email : <Text />} </Link>
                  </Box>
                  <Box as='div'
                  display={'flex'}
                  flexDirection={'column'}
